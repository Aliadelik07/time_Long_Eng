...
This experiment was created using PsychoPy3 Experiment Builder (v2021.1.3),
    on Mon 22 Mar 2021 09:26:15 AM MSK
...
expName = 'time_perception_2Phases_Longer'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/home/ad/Desktop/Сысоева/time_Long_Eng/time_perception_2Phases_Longer_lastrun.py',
...
responseImg = visual.ImageStim(
    win=win,
    name='responseImg', 
    image='img\\resp_longer.png', mask=None,
...
for thisSecondPhase in SecondPhase:
    ...
    if Experiment_Round <= 2:
        TextSecond = "The experiment's First Phase has finished.\nNow it's time to start Second Phase.\nPerss 'space' to start."
    else:
        TextSecond = "Your experiment has finished! \n Press 'Space' to continue."
